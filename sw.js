...
const APP_SHELL = [
  ...
  "./main.js",
  "./app.js",
  "./elements/register.js",
  "./elements/add-menu.js",
  "./elements/component-card.js",
  "./elements/dialog-frame.js",
  "./elements/inspector.js",
  "./elements/task-list.js",
  "./elements/widget-frame.js",
  "./elements/workspace-nav.js",
  "./elements/element-utils.js",
  "./offline/register.js",
  "./storage/directory-vault.js",
  "./storage/memory-vault.js",
  "./storage/component-card-catalog.js",
  "./storage/component-card-codec.js",
  "./storage/component-card-repository.js",
  "./storage/widget-catalog.js",
  "./storage/widget-repository.js",
  "./storage/life-indexer.js",
  "./storage/life-query.js",
  "./storage/index-integrity.js",
  "./storage/memory-index.js",
  "./storage/task-repository.js",
  "./storage/journal-event-repository.js",
  "./storage/note-catalog.js",
  ...
  "./ai/generated-operations.js",
  "./widgets/widget-policy.js",
  "./widgets/widget-envelope.js",
  "./widgets/widget-protocol.js",
  "./styles/layers.css",
  "./styles/tokens.css",
  ...
  "./design-system/fonts/jetbrainsmono-400-latin-ext.woff2",
  "./design-system/fonts/jetbrainsmono-400-latin.woff2",
  "./design-system/fonts/jetbrainsmono-500-latin-ext.woff2",
  "./design-system/fonts/jetbrainsmono-500-latin.woff2",
  "./design-system/fonts/newsreader-500-latin-ext.woff2",
  "./design-system/fonts/newsreader-500-latin.woff2",
  "./design-system/fonts/newsreader-600-latin-ext.woff2",
  "./design-system/fonts/newsreader-600-latin.woff2",
  "./design-system/fonts/worksans-400-latin-ext.woff2",
  "./design-system/fonts/worksans-400-latin.woff2",
  "./design-system/fonts/worksans-500-latin-ext.woff2",
  "./design-system/fonts/worksans-500-latin.woff2",
