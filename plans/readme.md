...
| 145 | Cloud-preset picker UI — pick a provider, add only an API key + consent; existing free-form moves behind an "Advanced · custom endpoint" disclosure; consent gate untouched | P1 | M | MED | 144 | — | TODO |
| 146 | Models page UX/UI polish — style the unstyled `.runtime-row*` + `.model-dl-*` download meter (confirmed CSS gaps), sharpen the selected-processor pill + empty state; additive CSS only | P2 | M | LOW | — | — | TODO |
