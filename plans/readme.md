...
| 054 | Heads: focus + dock conversation selector + retire `/heads`,`/heads/{id}/chat` (Phase 4) | P1 | L | HIGH | 050, 053 | — | TODO (authored — `plans/054-heads-focus-dock-conversation.md`; the one live-dock-chat-plumbing change; extra review rigor) |
