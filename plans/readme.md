...
| 099 | Domain tabs inside the panel; simplify the rail to top-level domains ("same treatment for the other sidebar entries") | P1 | M | MED | **098** | — | PLANNED (expand once 098 lands) |
| 100 | Panel responsive + sidebar chrome (full a11y drawer, mobile rail reveal, switcher placement, panel resize) — **supersedes 091** | P2 | M | MED | **098** (099 soft) | — | PLANNED (expand once 098 lands) |
