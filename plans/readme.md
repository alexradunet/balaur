...
| 055 | Life: new lifelog card (read-only overview) + retire `/life` (Phase 5) | P2 | M | LOW–MED | 050, 052 | — | TODO (authored — `plans/055-life-focus.md`; reconciled: no entry-create, chat logs entries) |
