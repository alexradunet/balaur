...
| 056 | Settings card (profile+models) + retire `/settings`,`/profile`,`/models` (Phase 6) | P2 | L | MED | 050, 053 | — | TODO (authored — `plans/056-settings-focus.md`; skills leaves settings → its own card, killing the Phase-3 dup) |
