...
| 056 | Settings card (profile+models) + retire `/settings`,`/profile`,`/models` (Phase 6) | P2 | L | MED | 050, 053 | — | DONE (settings card focus = the shell; `/settings`,`/settings/{section}`,`/profile`,`/models` retired; write endpoints + section fragments kept; skills is its own card) |
