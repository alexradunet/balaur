...
| 087 | Owner-initiated llama.cpp runtime install — both CPU + Vulkan, into the lib dir the engine loads from | P1 | L | MED–HIGH | 086 (DONE) | — | IN PROGRESS (reconciled to post-086 `e4c6394`; executor dispatched) |
