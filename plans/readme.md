...
| 058 | Dock follow-up fixes: silent-403 on inactive head + back-to-main mid-stream race | P3 | S | MED | 054 | — | TODO (authored — `plans/058-dock-followup-fixes.md`; the two deferred Phase-4 dock UX edge cases) |
