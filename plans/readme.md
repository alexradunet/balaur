...
| 055 | Life: new lifelog card (read-only overview) + retire `/life` (Phase 5) | P2 | M | LOW–MED | 050, 052 | — | DONE (`plans/055-life-focus.md`; lifelog card tile + /focus/lifelog; /life retired; no entry-create, chat logs entries) |
