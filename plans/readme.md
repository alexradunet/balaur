...
| 053 | Knowledge: memory+skills focus + retire `/memory`,`/skills` (Phase 3) | P1 | M | MED | 050, 052 | — | DONE (memory+skills card focuses render the full `knowledge_body` manager; `/memory`+`/skills` retired → 302 `/boards`; `knowledge_body` moved to `knowledge-focus.html` so `/settings/skills` keeps working) |
