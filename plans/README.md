...
| 195 | Sovereign export Phase 3 — passphrase-encrypted backup over the mirror (CGO-free via `x/crypto`; "lost passphrase = lost backup") | P3 | M | 194 | TODO — **HELD** (encryption of the sovereign record; cold-reviewed + refreshed for post-194/197 main; owner approved; executing) |
