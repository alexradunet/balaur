...
var allTypes = []string{
	...
	"day", "period", "measure", "lines", "note", "memory", "skills", "related", "graph", "network", "heads", "habits", "lifelog", "tasks", "settings", "review", "chronicle",
}
...
func TestValidateMemoryCategory(t *testing.T) {
